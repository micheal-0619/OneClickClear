package com.axb.oneclickclear.utils;

import android.util.Log;

import com.axb.oneclickclear.BuildConfig;
import com.axb.oneclickclear.MainApplication;
...
public class UtilLog {
    ...
    public static void v(String tab, String message) {
        if (MainApplication.getInstance().getPackageName().contains(".test") || DEBUG) {
